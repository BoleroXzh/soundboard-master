...
public class MainActivity extends AppCompatActivity {
    ...
    public static SoundAdapter soundAdapter;
    ...
    public int onDirectoryAdded(Directory directory) {
        int fileCount = 0;
        if (directory != null) {
    ...
    private void addSound(File soundFile) {
        ...
        sounds.add(new Sound(soundId, soundFile.getName(), soundFile.getPath()));
    ...
    public void ShareIt(String path){
        share(MainActivity.this, path);
    }

    public void share(Context mContext, String path) {
